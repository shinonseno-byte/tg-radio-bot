...
- للمشاكل المعقدة: وجّه العميل إلى فريق الدعم المختص
...
3️⃣ الدعم الفني:
- استكشاف مشكلات الاتصال بالإنترنت والشبكات
- حل مشكلات البرامج والتطبيقات
- الإجابة على الأسئلة الشائعة
- توجيه المستخدم خطوة بخطوة لحل المشكلة

📌 قواعد مهمة:
- حدد نية المستخدم ذكياً من الكلمات والسياق
- استخدم اللغة العربية الفصحى البسيطة والواضحة
- كن موجزاً ومباشراً
- أظهر التعاطف في مشاكل العملاء`;
...
client.on("message", async (message) => {
  // تجاهل الرسائل من المجموعات والبوتات
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .status {
      ...
      font-size: 14px;
      margin: 15px 0;
      background: ${isReady ? "rgba(37,211,102,0.15)" : "rgba(255,200,0,0.15)"};
      color: ${isReady ? "#25D366" : "#ffc800"};
      border: 1px solid ${isReady ? "#25D366" : "#ffc800"};
    }
    .qr-box {
      background: #fff;
      border-radius: 16px;
